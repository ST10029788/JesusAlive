...
import com.scriptsquad.reflectionsoffaith.databinding.ActivityPdfEditBinding
...
class PdfEditActivity : AppCompatActivity() {
    ...
    private fun loadBooksInfo() {
        Log.d(TAG, "loadBooksInfo: Loading Devotional_Material Info")
    ...
    private fun updatePdf(){
        ...
        // show progress
        progressDialog.setMessage("Updating Devotional_Material info")
        progressDialog.show()
