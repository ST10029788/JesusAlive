...
import com.scriptsquad.reflectionsoffaith.databinding.ActivityPdfAddBooksBinding
...
// get the id of the item clicked in popup menu
    ...
    private val requestStoragePermission = registerForActivityResult(
        ...
        if (isGranted) {
            ...
            //Storage Permission denied, we can't launch Church_Events_Feed to pick images
